...
/* ***************************
 *  Get all inventory items by vehicle_id
 * ************************** */
...
async function getError(error_id) {
  try {
    const data = await pool.query(
      `SELECT * FROM public.inventory AS i 
      WHERE i.inv_id = $1`,
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByVehicleId, getError, addClassification, addVehicle, updateVehicle, deleteVehicle};